...
-- - 계약 보호자 동의 (CONTRACT_CONSENT purpose + contract_id) 폐지 (2026-07-10). 민법 제5조 제1항 사전 포괄 동의 불가
-- → 상대방 위험 고지 확인 방식으로 대체
...
COMMENT ON COLUMN guardian_links.purpose IS 'SIGNUP (미성년 가입). 계약 보호자 동의 폐지 (2026-07-10) — 향후 다른 purpose 확장 대비 컬럼 유지';
