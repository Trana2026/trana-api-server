...
-- - 미성년 계약 단계 보호자 동의 = 항상 선택 (creator: contracts.guardian_consent_at / receiver: contract_parties.guardian_consent_at)
-- ============================================================
...
(
    ...
    -- 계약 단계 보호자 동의 (미성년 — 항상 선택)
    -- creator: 계약 레벨 / receiver: contract_parties 레벨
    guardian_id                BIGINT,
...
COMMENT ON COLUMN contracts.guardian_id IS '계약 단계 매핑된 보호자 user_id (creator 미성년 동의 시 채움, 논리 FK)';
COMMENT ON COLUMN contracts.guardian_consent_at IS 'creator 미성년의 계약 단위 보호자 동의 시점 (선택 — receiver 미성년은 contract_parties.guardian_consent_at 사용)';
...
COMMENT ON COLUMN contract_parties.guardian_consent_at IS '미성년 party 의 계약 단위 보호자 동의 시점 (선택 — 미완료여도 서명 가능, 상대에게 riskSignal 로 표기)';
